...
3. Add ``pdfview`` to the ``ckan.plugins`` setting in your CKAN
...
Document any optional config settings here. For example::
    ...
    # (optional, default: 24).
    ckanext.pdfview.some_setting = some_default_value
...
coverage installed in your virtualenv (``pip install coverage``) then run::
    ...
    nosetests --nologcapture --with-pylons=test.ini --with-coverage --cover-package=ckanext.pdfview --cover-inclusive --cover-erase --cover-tests
